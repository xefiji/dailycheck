...
var $author$project$Checkout$ReceiveDate = function (a) {
	return {$: 'ReceiveDate', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Checkout$ReceiveDatas = function (a) {
	return {$: 'ReceiveDatas', a: a};
};
var $author$project$Checkout$Day = F8(
	function (day, sleep, energy, intellect, anxiety, family, social, work) {
		return {anxiety: anxiety, day: day, energy: energy, family: family, intellect: intellect, sleep: sleep, social: social, work: work};
	});
...
var $author$project$Checkout$dayDecoder = A3(
					...
					A3(
						...
						A3(
							...
							A3(
								...
								$elm$json$Json$Decode$succeed($author$project$Checkout$Day)))))))));
...
var $author$project$Checkout$url = 'http://localhost:5016/daily-check.json';
var $author$project$Checkout$fetchData = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Checkout$ReceiveDatas, $author$project$Checkout$dayDecoder),
		url: $author$project$Checkout$url
	});
...
var $author$project$Checkout$init = function (_v0) {
	var day = {
		anxiety: 0,
		day: $justinmimbs$date$Date$toIsoString(
	...
	return _Utils_Tuple2(
		{day: day, toasties: $pablen$toasty$Toasty$initialState},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Task$perform, $author$project$Checkout$ReceiveDate, $justinmimbs$date$Date$today),
					$author$project$Checkout$fetchData
				])));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Checkout$ToastyMsg = function (a) {
...
var $author$project$Checkout$buildErrorMessage = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
...
var $author$project$Checkout$getValOrDefault = function (val) {
	return A2(
...
var $author$project$Checkout$toastyConfig = A2(
	$pablen$toasty$Toasty$delay,
	8000,
	A2($pablen$toasty$Toasty$transitionOutDuration, 100, $pablen$toasty$Toasty$config));
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									sleep: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateEnergy':
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									energy: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateIntellect':
				var value = msg.a;
				var dayToUpdate = model.day;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									intellect: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateAnxiety':
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									anxiety: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateFamily':
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									family: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateSocial':
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									social: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateWork':
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									work: $author$project$Checkout$getValOrDefault(value)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReceiveDate':
					...
					_Utils_update(
						model,
						{
							day: _Utils_update(
								dayToUpdate,
								{
									day: $justinmimbs$date$Date$toIsoString(today)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				...
				return A4(
					$pablen$toasty$Toasty$addToast,
					$author$project$Checkout$toastyConfig,
					$author$project$Checkout$ToastyMsg,
					'successfully saved day',
					_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
			case 'ReceiveDatas':
				if (msg.a.$ === 'Ok') {
					var day = msg.a.a;
					var _v2 = A2($elm$core$Debug$log, 'day ', day);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{day: day}),
					...
					var _v3 = A2($elm$core$Debug$log, 'error ', httpError);
					return A4(
						$pablen$toasty$Toasty$addToast,
						$author$project$Checkout$toastyConfig,
						$author$project$Checkout$ToastyMsg,
						$author$project$Checkout$buildErrorMessage(httpError),
						_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
				}
			default:
				var subMsg = msg.a;
				return A4($pablen$toasty$Toasty$update, $author$project$Checkout$toastyConfig, $author$project$Checkout$ToastyMsg, subMsg, model);
		}
	});
var $author$project$Checkout$Submit = {$: 'Submit'};
var $author$project$Checkout$UpdateAnxiety = function (a) {
	return {$: 'UpdateAnxiety', a: a};
};
var $author$project$Checkout$UpdateEnergy = function (a) {
	return {$: 'UpdateEnergy', a: a};
};
var $author$project$Checkout$UpdateFamily = function (a) {
	return {$: 'UpdateFamily', a: a};
};
var $author$project$Checkout$UpdateIntellect = function (a) {
	return {$: 'UpdateIntellect', a: a};
};
var $author$project$Checkout$UpdateSleep = function (a) {
	return {$: 'UpdateSleep', a: a};
};
var $author$project$Checkout$UpdateSocial = function (a) {
	return {$: 'UpdateSocial', a: a};
};
var $author$project$Checkout$UpdateWork = function (a) {
...
var $author$project$Checkout$renderToast = function (toast) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(toast)
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Daily Check')
							])),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(model.day.day)
							])),
						A4($pablen$toasty$Toasty$view, $author$project$Checkout$toastyConfig, $author$project$Checkout$renderToast, $author$project$Checkout$ToastyMsg, model.toasties),
						A3($author$project$Checkout$viewStars, 'sleep', model.day.sleep, $author$project$Checkout$UpdateSleep),
						A3($author$project$Checkout$viewStars, 'energy', model.day.energy, $author$project$Checkout$UpdateEnergy),
						A3($author$project$Checkout$viewStars, 'intellect', model.day.intellect, $author$project$Checkout$UpdateIntellect),
						A3($author$project$Checkout$viewStars, 'anxiety', model.day.anxiety, $author$project$Checkout$UpdateAnxiety),
						A3($author$project$Checkout$viewStars, 'family', model.day.family, $author$project$Checkout$UpdateFamily),
						A3($author$project$Checkout$viewStars, 'social', model.day.social, $author$project$Checkout$UpdateSocial),
						A3($author$project$Checkout$viewStars, 'work', model.day.work, $author$project$Checkout$UpdateWork)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Checkout$main = $elm$browser$Browser$element(
	{
		init: $author$project$Checkout$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Checkout$update,
		view: $author$project$Checkout$view
	});
_Platform_export({'Checkout':{'init':$author$project$Checkout$main(
